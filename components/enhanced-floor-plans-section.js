    ...
    <section className="py-16 md:py-24 bg-stone-100 overflow-hidden">
      <div className="container-responsive mx-auto">
        ...
        <div className="flex flex-col md:flex-row gap-8 md:gap-12">
          ...
          >
            <div className="bg-stone-50 p-6 border border-gold/20 hover:shadow-xl transition-shadow duration-300 luxury-card">
              ...
              <div className="flex justify-between items-center">
                <span className="text-sm text-stone-500 font-light">Units: 1, 4, 5, 8, 9, 12, 13, 16</span>
          ...
          >
            <div className="bg-stone-50 p-6 border border-gold/20 hover:shadow-xl transition-shadow duration-300 luxury-card">
              ...
              <div className="flex justify-between items-center">
                <span className="text-sm text-stone-500 font-light">Units: 2, 6, 7, 10, 11, 14, 15, 17, 18</span>
                <button className="text-gold hover:text-gold/80 font-light flex items-center btn-luxury">
                  <span>View Details</span>
                  <ChevronRight size={16} className="ml-1" />
                </button>
