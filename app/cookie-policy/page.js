    ...
    <div className="bg-white min-h-screen pt-24 pb-16">
      <div className="container-responsive mx-auto">
        ...
        <div className="prose max-w-none">
          ...
          <h2 className="text-2xl font-serif mt-8 mb-4">2. How We Use Cookies</h2>
          <p className="text-gray-700">Marbella Apartments uses cookies for various purposes, including:</p>
          ...
          <h2 className="text-2xl font-serif mt-8 mb-4">3. Types of Cookies We Use</h2>
          <p className="text-gray-700">We use the following types of cookies on our website:</p>
          <ul className="list-disc pl-6 text-gray-700 space-y-2 mt-4">
            <li>
            ...
            <li>
              <strong>Third-Party Cookies:</strong> These are cookies set by third parties, such as Google Analytics.
            </li>
          </ul>
          ...
          <p className="text-gray-700 mt-4">
            The following links show how to adjust your cookie settings in common browsers:
          </p>
          <ul className="list-disc pl-6 text-gray-700 space-y-2 mt-4">
            <li>
              <a
          ...
          <h2 className="text-2xl font-serif mt-8 mb-4">5. Changes to Our Cookie Policy</h2>
          <p className="text-gray-700">
